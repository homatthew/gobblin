...
//      }
    ...
    /**
     * The below block is commented out because requesting new containers upon failure will cause an explosion in the number
     * of containers until the autoscaling manager is re-implemented
     */
